      ...
      >
        ...
        <NavbarBrand className="mr-2 w-[40vw] md:w-auto md:max-w-fit">
          <div className="rounded-full bg-foreground text-background">
            <img src="favicon.png" className="w-9 md:w-10" />
          </div>
          <span className="ml-2 font-medium md:hidden tracking-widest">Dropset</span>
        </NavbarBrand>
        ...
        <NavbarItem className="ml-2 !flex">
          <Button radius="full" variant="flat" className="font-bold">
            Download
          </Button>
        </NavbarItem>
      </NavbarContent>
